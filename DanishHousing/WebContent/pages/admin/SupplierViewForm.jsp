...
<body class="hold-transition skin-blue sidebar-mini" onload="formin();">
			...
			<section class="content">
				...
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title"> Supplier View Form</h3>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group" id="divSupplierFormName">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control"
												...
												name="supplierName"
												value="${requestScope.supplier.supplName }" />
										</div>
									...
									<div class="form-group" id="divSupplierFormAddress1">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control"
												...
												value="${requestScope.supplier.supplAdd1 }" />
										</div>
									...
									<div class="form-group" id="divSupplierFormAddress2">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control"
												...
												value="${requestScope.supplier.supplAdd2 }" />
										</div>
									...
									<div class="form-group" id="divSupplierFormCity">
										...
										<div class="input-group">
											<span class="input-group-addon"><i
												...
												name="supplierCity"
												value="${requestScope.supplier.supplAdd3 }" />
										</div>
										<p id="errorCity"></p>
									</div>
									<!-- End City -->
									...
									<input type="hidden" class="form-control" id="showId"
										name="showId" value="${requestScope.supplier.supplId}" />
									<!-- /.form group -->
									...
									<div class="form-group" id="divSupplierFormBalance">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control" id="balance"
												name="balance" value="${requestScope.supplier.balance }" />
										</div>
										<p id="errorBalance"></p>
									</div>
									<!-- End Opening Balance -->
										...
										<div class="input-group date">
											...
											<span id="formattedDate1" name="formattedDate1"
												style="display: none;"><fmt:formatDate type="date"
													pattern="dd/MM/yyyy"
													value="${requestScope.supplier.balDt }" /></span> <input
									...
									<div class="form-group" id="divSupplierFormPAN">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control" id="supplierPAN"
												...
												value="${requestScope.supplier.panNo }" />
									...
									<div class="form-group" id="divSupplierFormGST">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control" id="supplierGST"
												...
												value="${requestScope.supplier.gstNo}" />
										</div>
										<p id="errorGST"></p>
										<!-- /.input group -->
									</div>
	...
	<script>
		...
		function formin() {
			...
			document.getElementById("balDt").value = document
