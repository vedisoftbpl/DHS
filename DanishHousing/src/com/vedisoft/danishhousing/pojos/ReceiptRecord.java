...
public class ReceiptRecord {
	...
	public ReceiptRecord(int sNo, char payType, int slno, Date recDte, int receno, String receiptNo, String prefix,
			String membNme, int membNo, String fHNme, String mad1, String mad2, String mad3, Double amount,
			...
			String remarks, char rC, String pD, String accode, String branch, String dC, Date wLrDt, int userId,
			Date lastUpdate, String city) {
		super();
		this.sNo = sNo;
	...
	public String toString() {
		return "ReceiptRecord [sNo=" + sNo + ", payType=" + payType + ", slno=" + slno + ", recDte=" + recDte
				+ ", receno=" + receno + ", receiptNo=" + receiptNo + ", prefix=" + prefix + ", membNme=" + membNme
				+ ", membNo=" + membNo + ", fHNme=" + fHNme + ", mad1=" + mad1 + ", mad2=" + mad2 + ", mad3=" + mad3
				+ ", amount=" + amount + ", balChq=" + balChq + ", cDd=" + cDd + ", cDdte=" + cDdte + ", fullPay="
				+ fullPay + ", inst1=" + inst1 + ", inst2=" + inst2 + ", inst3=" + inst3 + ", chalNo=" + chalNo
				+ ", chalDte=" + chalDte + ", plSize=" + plSize + ", plNo=" + plNo + ", projCd=" + projCd + ", chqDhr="
				+ chqDhr + ", flag=" + flag + ", trCode=" + trCode + ", remarks=" + remarks + ", rC=" + rC + ", pD="
				+ pD + ", accode=" + accode + ", branch=" + branch + ", dC=" + dC + ", wLrDt=" + wLrDt + ", userId="
				+ userId + ", lastUpdate=" + lastUpdate + ", city=" + city + "]";
	}
