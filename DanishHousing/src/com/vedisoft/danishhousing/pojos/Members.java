...
public class Members {
	...
	public Members(int memberId, int projectCd, int memberNo, String plotSize, float netPlotSize, String regCor,
			...
			String nomineeName, int memFee, int memEntryFee, Date receiptdt, String fullPay, int inst1, int inst2,
			int inst3, String transf, double opBal, String waterConn, String secDep, Date waterConnDate, Date opDt,
	...
	public void setInst2(int inst2) {
		this.inst2 = inst2;
	}
	...
	public void setInst3(int inst3) {
		this.inst3 = inst3;
	}
