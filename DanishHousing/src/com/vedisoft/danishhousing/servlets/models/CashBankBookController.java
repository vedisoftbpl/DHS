...
/**
 * Servlet implementation class CashBankController
 */
@WebServlet("/admin/pages/CashBankBookController")
public class CashBankBookController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CashBankBookController() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int msg = 2;
		String page = "/pages/admin/CashBankBook.jsp";
